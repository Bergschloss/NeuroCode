...
const ink4 = '#7a7a7a';
const rule = '#666';
const plateBg = '#a8a8a8';
const tMono = 'Space Mono, monospace';

/* ===== Plate wrapper ===== */
const Plate = ({ idx, label, children }) => (
  <div style={{
    width:'100%', height:'100%', background:plateBg, color:ink,
...
Sym.s05 = () => (
  <svg viewBox="0 0 170 170">
    <g stroke={ink} fill="none">
      ...
      <g>
        <rect x="80" y="40" width="10" height="90" fill={plateBg}/>
...
Sym.s19 = () => (
  <svg viewBox="0 0 170 170">
    <g transform="translate(85 85)">
      ...
      <circle r="3" fill={plateBg} stroke={ink} strokeWidth=".7"/>
    </g>
  </svg>
);
